...
class TestAtlassianSessionHTTP:
    ...
    def test_rate_limit_retry(self):
        ...
        resp_lib.add(resp_lib.GET, "https://test.atlassian.net/test", json={"ok": True}, status=200)
        s = self._session()
    ...
    def test_404_raises(self):
        resp_lib.add(
            resp_lib.GET,
            "https://test.atlassian.net/missing",
    ...
    def test_get_binary_returns_bytes(self):
        ...
        resp_lib.add(
            resp_lib.GET,
            "https://test.atlassian.net/img.png",
            body=png,
            status=200,
...
class TestConfluenceClientPagination:
    ...
    def test_paginate_v1_offset(self):
        ...
        page2 = {"results": [{"id": "c"}], "size": 1, "limit": 2, "start": 2, "totalSize": 3}
        client.session.get_json = MagicMock(side_effect=[page1, page2])
    ...
    def test_get_spaces_filtered(self):
        ...
        client.session.get_json = MagicMock(return_value={"results": all_spaces, "_links": {}})
